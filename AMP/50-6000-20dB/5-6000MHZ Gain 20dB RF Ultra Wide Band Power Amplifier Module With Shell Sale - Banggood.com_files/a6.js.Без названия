...
var R=[
  ...
  [{
    ...
    id: 40,
    idS: '8_1',
    s: function(cb){ld('//ad.adriver.ru/cgi-bin/rle.cgi?sid=1&ad=645526&bt=21&pid=2679048&bn=5355482&rnd='+rnd, cb)},
    t: 24	
  },{
    id: 41,
    idS: '9_1',
    s: function(cb){ld('//ad.adriver.ru/cgi-bin/rle.cgi?sid=1&ad=652334&bt=21&rnd='+rnd, cb)},
    t: 24	
  },{
    id: 28,
    idS: '7_3',
